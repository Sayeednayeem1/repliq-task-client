            ...
            <div className='my-16'>
                <div className="hero" >
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        ...
                        <div>
                            <p className='mb-4'>We have 100+ great services you deserve!</p>
                            <h1 className="text-5xl font-bold">Find The Most Exciting</h1>
                            <h1 className="text-5xl font-bold mt-2">Services</h1>
                            <form className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-8 p-0 lg:p-5 shadow-xl rounded-xl'>
                                <input type="text" placeholder="Service Title" className="input w-full max-w-xs" />
